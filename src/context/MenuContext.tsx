...
export const MenuProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const initialX = window.innerWidth * 0.47; // 50% of screen width (center of right half)
  const initialY = window.innerHeight *0.17; // Center vertically, offset by half button height
